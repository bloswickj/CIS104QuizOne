...
38. The start of a while loop. continueResponse !== (not equal to and same data type as) 0 && continueResponse !== 1 is used as the test for the loop.
...
55. Start of if statement. typeof currentGrade !== 'undefined' (another way of testing if a variables value has been set) && currentGrade <= MAX_GRADE is used as the test.
